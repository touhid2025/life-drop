              ...
              <tr key={blog._id} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-2 text-right space-y-1 md:space-x-2 md:space-y-0">
                  <button
                    ...
                    className={`w-full cursor-pointer md:w-auto px-3 py-1 rounded text-white text-xs font-medium transition ${
                      blog.status === "published"
                  ...
                  <button
                    ...
                    className="w-full cursor-pointer md:w-auto bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-xs font-medium transition"
                  >
                    <span className="flex items-center justify-center gap-1">
                      <MdDelete /> Delete
                    </span>
